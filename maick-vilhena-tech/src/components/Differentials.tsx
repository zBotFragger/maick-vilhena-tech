      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Por que escolher a <span className="text-cyan">MVT</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-x-12 md:gap-y-16 lg:gap-y-20">
          ...
          <div className="relative flex flex-col items-center justify-center p-8 bg-cyan/10 rounded-2xl border border-cyan/20 group hover:bg-cyan/20 transition-colors">
